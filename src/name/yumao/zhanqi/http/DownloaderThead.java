...
public class DownloaderThead implements Runnable{
	...
	public void run() {
		while(true){
			...
			httpVideoDownloader.download(inNum,butnSure,HttpClientFromZhanqi.QueryZhanqiDownloadUrl(inNum.getText()), "record\\" + simpleDateFormat.format(calendar.getTime())+"-"+inNum.getText()+".flv");
