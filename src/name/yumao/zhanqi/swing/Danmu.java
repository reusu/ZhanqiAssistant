...
public class Danmu extends JFrame implements ActionListener{
	...
	private JLabel titleLabel=new JLabel("战旗TV评论小助手");
	...
	private JLabel supLabel=new JLabel(HttpClientFromZhanqi.showAnnounce());
	...
	public Danmu(){
		...
		titlePanel.setBorder(new MatteBorder(0, 1, 0, 1, new Color(100,149,237)));
		add(titlePanel);
		bodyPanel.setBounds(0, 30, 320, 150);
		bodyPanel.setBackground(new Color(255,255,255));
		bodyPanel.setBorder(new MatteBorder(0, 1, 1, 1, new Color(100,149,237)));
		add(bodyPanel);
		//标题栏
		...
		inNum.setBorder(new MatteBorder(1, 1, 1, 1, new Color(100,149,237)));
		add(inNum,0);
		butnSure.setBounds(160,50,100,90);
		butnSure.setFont(new Font("微软雅黑",Font.BOLD,32));
		butnSure.setForeground(new Color(100,149,237));
		butnSure.setMargin(new Insets(0, 0, 0, 0));
		butnSure.setBorder(new MatteBorder(1, 1, 1, 1, new Color(100,149,237)));
		...
		supLabel.setForeground(new Color(100,149,237));
		add(supLabel,0);
...
//			// 开始启动登入Mina线程
			ContentMinaThread zhanqiMina = new ContentMinaThread(null,zhanqiApiServerVo,roomViewerVo,inNum,butnSure);
